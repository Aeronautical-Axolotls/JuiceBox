use crate::{
    juice_renderer::draw_vector_arrow,
    simulation::{SimConstraints, SimGrid},
    util::cartesian_to_polar,
};
use bevy::prelude::*;
...
fn test_sprite_particle_linking() {
    ...
    let mut system_state =
        bevy::ecs::system::SystemState::<Commands>::new(&mut juicebox_test.world);
    ...
    let particle: Entity = commands
        .spawn(crate::simulation::SimParticle {
    ...
    let sprite_count: usize = juicebox_test
        .world
        .query::<(&crate::simulation::SimParticle, With<Sprite>)>()
